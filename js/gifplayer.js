	...
	var SuperGif = function (opts) {
		...
		return {
			...
			load: function (callback) {
				this.load_url(gif.getAttribute('rel:animated_src') || gif.src || gif.getAttribute('data-src'), callback);
			},
...
// const images = Array.from(document.querySelectorAll('img[src$=".gif"]'));

var gifElements = document.querySelectorAll('img[data-src$=".gif"]');
